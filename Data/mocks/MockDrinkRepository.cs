...
namespace DrinkAndGo.Data.Mocks
{
    ...
    {
        private readonly ICatagoryRepository _categoryRepository = new MockCatagoryRepository();
            ...
            get
            {
                return new List<Drink>
                {
                    new Drink {
                        ...
                        Catagory = _categoryRepository.Catagories.First(),
                        ImgUrl = "https://agriculture.ec.europa.eu/sites/default/files/styles/oe_theme_medium_no_crop/public/2022-07/munchener-bier_555x325_en.png?itok=NsRDvI7i",
                        InStock = true,
                        IsPrefferedDrink = true,
                        ImageThumbnailUrl = "https://agriculture.ec.europa.eu/sites/default/files/styles/oe_theme_medium_no_crop/public/2022-07/munchener-bier_555x325_en.png?itok=NsRDvI7i"
                    },
                    new Drink {
                        Name = "Rum & Coke",
                        ...
                        Catagory =  _categoryRepository.Catagories.First(),
                        ImgUrl = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.umami.site%2Frecipes%2Frum-and-coke%2F&psig=AOvVaw2f_2fevREA7QJZssO4Dw-j&ust=1720968920146000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCLDhuvyipIcDFQAAAAAdAAAAABAE",
                        InStock = true,
                    ...
                    new Drink {
                        ...
                        Catagory =  _categoryRepository.Catagories.First(),
                        ImgUrl = "https://www.foodandwine.com/thmb/ljF38kbAuE7097aZaNyqHHpHKpE=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/Tequlia-NOM-tout-FT-BLOG0723-24d2672b83c2454b810cab9da2b018e7.jpg",
                        InStock = true,
                        IsPrefferedDrink = false,
                        ImageThumbnailUrl = "https://www.foodandwine.com/thmb/ljF38kbAuE7097aZaNyqHHpHKpE=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/Tequlia-NOM-tout-FT-BLOG0723-24d2672b83c2454b810cab9da2b018e7.jpg"
                    },
                    new Drink
                    {
                        Name = "Juice ",
                        ...
                        Catagory = _categoryRepository.Catagories.Last(),
                        ImgUrl = "https://assets.clevelandclinic.org/transform/47cdb246-3c9d-4efb-8b3b-1e6b85567a16/Fruit-Juice-155376375-770x533-1_jpgh",
                        InStock = true,
                        IsPrefferedDrink = false,
                        ImageThumbnailUrl = "https://assets.clevelandclinic.org/transform/47cdb246-3c9d-4efb-8b3b-1e6b85567a16/Fruit-Juice-155376375-770x533-1_jpg"
                    }
                };
            }
            set
        ...
        public IEnumerable<Drink>? PrefferredDrinks { get; set; }
